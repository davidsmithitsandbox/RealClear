...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onSubmit: function onSubmit() {
      axios.post(window.location.pathname + '/login', this.$data).then(this.onSuccess);
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onSubmit: function onSubmit() {
      axios.post(window.location.pathname + '/register', this.$data).then(this.onSuccess);
    },
    onSuccess: function onSuccess() {
      this.$router.push("/tasks");
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onSubmit: function onSubmit() {
      axios.post(window.location.pathname + '/tasks', this.$data).then(this.onSuccess);
    },
    onSuccess: function onSuccess() {
      var _this = this;
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "container", staticStyle: { "padding-top": "1rem" } },
    [
                ...
                [
                  ...
                  _c("div", { staticClass: "form-group row" }, [
                    _c(
                      ...
                      [_vm._v("Password (8 Characters min)")]
                    ),
                    _vm._v(" "),
                    _c("div", { staticClass: "col-md-4" }, [
                      _c("input", {
...
/* harmony import */ var _components_Tasks_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Tasks.vue */ "./resources/js/components/Tasks.vue");
// Import components for the purposes of this project


 // REQUIRE

window.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // ROUTES
...
var routes = [{
  ...
  path: '/tasks',
  component: _components_Tasks_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
}]; // ROUTER
...
__webpack_require__(/*! /home/emnroot/public_html/realclear/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/emnroot/public_html/realclear/resources/sass/app.scss */"./resources/sass/app.scss");
